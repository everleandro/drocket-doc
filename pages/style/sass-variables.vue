<template>
  <div class="schedule-page">
    <div class="mb-12">
      <h1 class="text-h3 mb-2">Sass variables</h1>
      <p>
        the framework has a file that contains the variables that are used to
        generate the styles, this file is located in the path
        <code class="green--text mx-2 title">drocket/setting.scss</code> and can
        be modified to customize the styles of the components. In addition to
        this general configuration, each component has its own variables.
      </p>
    </div>
    <section class="mb-12">
      <h2 class="text-h4 mb-2">Global setting</h2>
      <p>
        Here are the available size options:
        <code class="green--text">x-small small large x-large</code>
      </p>
      <div style="position: relative">
        <copy-button />
        <div v-prism="{ class: 'language-scss' }">{{ HTML }}</div>
      </div>
    </section>
  </div>
</template>
